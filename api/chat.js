...
За каждую задачу-исполнителя: баллы за СТАТУС (0-5) + ВАЖНОСТЬ задачи по оценке AI (0-5).
- Статус: закрыта в срок = 5, закрыта с просрочкой = 3, открыта в срок = 2, без дедлайна = 1, открыта просрочена = 0.
- Важность (AI оценивает ценность задачи 1-10, нормируется): нет ценности = 0, средняя = 2.5, критичная = 5.
- Соисполнители получают столько же, сколько исполнитель.
- Постановщик получает за делегирование: +1 балл за задачу, порученную внутри своего отдела, и +2 балла за задачу, порученную в другой отдел.
