...
2. НЕПОНЯТНАЯ / ТОНКАЯ ЗАДАЧА: если описание пустое, короткое (одна строка, просто дата/пометка) или название размытое — ЗАНИЖАЙ на 2 балла и ставь по нижней границе. Нельзя высоко оценить то, что не раскрыто. При любом сомнении в ценности — иди ВНИЗ, а не вверх.
